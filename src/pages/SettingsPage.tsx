...
export function SettingsPage() {
    ...
    const previewReceiptData = useMemo(() => ({
        ...
        paymentMethod: 'CASH', customerName: 'Preview Customer', customerPhone: '9876543210',
            ...
            <div className="mx-auto flex max-w-6xl flex-col gap-4 p-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-slate-900 dark:text-white">Store Settings</h1>
                            <p className="text-xs text-slate-500 dark:text-zinc-400">Configure printers, theme, and store details</p>
                        </div>
                    </div>
                ...
                <div className="grid gap-4 lg:grid-cols-[1fr_0.85fr]">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-sm font-bold text-slate-900 dark:text-white">Store Identity</h2>
                            </div>
                            <div className="mt-3 grid gap-3 md:grid-cols-2">
                                <div>
                                    <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Store Name</label>
                                ...
                                <div>
                                    <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Phone</label>
                                ...
                                <div className="md:col-span-2">
                                    <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Address</label>
                                ...
                                <div className="md:col-span-2">
                                    <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Receipt Footer</label>
                                    <input value={localReceiptFooter} onChange={(e) => setLocalReceiptFooter(e.target.value)} className="h-9 w-full rounded-lg border border-slate-200 bg-slate-50 px-3 text-sm text-slate-900 outline-none transition focus:border-slate-400 focus:bg-white dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-sm font-bold text-slate-900 dark:text-white">Printer Routing</h2>
                            </div>
                            <div className="mt-3 grid gap-3 md:grid-cols-2">
                                <div>
                                    <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Bill Printer</label>
                                ...
                                <div>
                                    <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Barcode Printer</label>
                            ...
                            <div className="mt-3">
                                <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Thermal Bill Size</label>
                                    ...
                                    {(['3-inch', '4-inch'] as ReceiptPaperSize[]).map((size) => (
                                        ...
                                        >
                                            ...
                                            <p className={cn('mt-0.5 text-[11px]', localBillPaperSize === size ? 'text-white/70 dark:text-zinc-600' : 'text-slate-500 dark:text-zinc-500')}>
                                                {size === '3-inch' ? 'Compact counter bill' : 'Wider layout'}
                                            </p>
                                        </button>
                                    ))}
                                </div>
                        ...
                        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-sm font-bold text-slate-900 dark:text-white">Appearance & Billing</h2>
                            </div>
                            <div className="mt-3 grid gap-3">
                                <div>
                                    <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Theme</label>
                                    ...
                                    <p className="mt-1 text-[11px] text-slate-400 dark:text-zinc-500">Theme will apply after saving settings</p>
                                </div>

                                <div className="grid gap-3 md:grid-cols-[1fr_auto_auto] md:items-end">
                                    <div>
                                        <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Tax Rate (%)</label>
                                    ...
                                    <button onClick={() => setLocalTaxEnabled(!localTaxEnabled)} className={cn('rounded-lg px-3 py-2 text-xs font-semibold transition', localTaxEnabled ? 'bg-emerald-600 text-white' : 'border border-slate-200 bg-slate-50 text-slate-600 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-300')}>
                                        {localTaxEnabled ? 'Tax On' : 'Tax Off'}
                                    </button>
                                ...
                                <div>
                                    <label className="mb-1 block text-xs font-medium text-slate-500 dark:text-zinc-400">Currency</label>
                                    <div className="grid gap-2 md:grid-cols-3">
                        ...
                        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-sm font-bold text-slate-900 dark:text-white">Data Management</h2>
                            </div>
                            <div className="mt-3 rounded-lg border border-red-100 bg-red-50 p-3 dark:border-red-900/30 dark:bg-red-950/10">
                                <p className="text-xs text-red-700 dark:text-red-300">Clearing transaction history removes old bill records permanently.</p>
                                <div className="mt-2 flex gap-2">
                                    {!showDeleteConfirm ? (
                                        <button onClick={() => setShowDeleteConfirm(true)} className="rounded-lg bg-red-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-red-700">Delete History</button>
                                    ) : (
                                        <>
                                            <button onClick={() => setShowDeleteConfirm(false)} className="rounded-lg border border-red-200 bg-white px-3 py-2 text-xs font-semibold text-red-700 transition hover:bg-red-50 dark:border-red-800 dark:bg-transparent dark:text-red-300">Cancel</button>
                                ...
                                {showDeleteConfirm && (
                                    <div className="mt-2 flex items-start gap-2 rounded-lg border border-red-200 bg-white px-3 py-2 text-xs text-red-700 dark:border-red-900/30 dark:bg-red-950/10 dark:text-red-300">
                                        <AlertTriangle size={14} className="mt-0.5 shrink-0" /> This action cannot be undone.
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h2 className="text-sm font-bold text-slate-900 dark:text-white">Thermal Receipt Preview</h2>
                                    <p className="text-xs text-slate-500 dark:text-zinc-400">{localBillPaperSize === '3-inch' ? '3 inch' : '4 inch'} paper</p>
                                </div>
